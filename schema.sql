...
-- =========================================================
-- МИГРАЦИЯ: часы работы заведения
-- =========================================================
-- Свободный текст ("Пн–Вс: 09:00–22:00") вместо структурированного
-- расписания по дням — этого достаточно для отображения на странице места
-- и заметно проще формы добавления/редактирования заведения.
