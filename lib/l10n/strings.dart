...
class Strings {
  ...
  String get loadErrorGeneric => _t('Не удалось загрузить данные', 'Maʼlumotlarni yuklab boʻlmadi');
  ...
  // ---------------------------------------------------------------
  static const _categoryLabelRu = {'restaurant': 'Ресторан', 'cafe': 'Кафе', 'park': 'Парк', 'mall': 'ТЦ'};
  static const _categoryLabelUz = {'restaurant': 'Restoran', 'cafe': 'Kafe', 'park': 'Park', 'mall': 'SM'};
  static const _categoryPluralRu = {'restaurant': 'Рестораны', 'cafe': 'Кафе', 'park': 'Парки', 'mall': 'ТЦ'};
  static const _categoryPluralUz = {'restaurant': 'Restoranlar', 'cafe': 'Kafelar', 'park': 'Parklar', 'mall': 'SMlar'};
  ...
  String get categoryEmpty => _t('В этой категории пока пусто', 'Bu toifada hozircha boʻsh');
  ...
  String get searchLoadError => _t('Не удалось загрузить результаты', 'Natijalarni yuklab boʻlmadi');
  String get nothingFound => _t('Ничего не найдено', 'Hech narsa topilmadi');
  String get nothingFoundHint =>
      _t('Попробуйте изменить запрос или выбрать другую категорию', 'Soʻrovni oʻzgartiring yoki boshqa toifani tanlang');
  ...
  String get placeLoadError =>
      _t('Не удалось загрузить место. Проверьте подключение и попробуйте снова.', 'Joyni yuklab boʻlmadi. Ulanishni tekshirib, qayta urinib koʻring.');
  ...
  String get noDescription => _t('Описание места пока не добавлено.', 'Joy tavsifi hali qoʻshilmagan.');
  ...
  String get noReviewsYet => _t('Пока нет отзывов — станьте первым', 'Hozircha sharhlar yoʻq — birinchi boʻling');
  String get noPhotosYet => _t('Фото пока не добавлены', 'Fotolar hali qoʻshilmagan');
  ...
  // ---------------------------------------------------------------
  String get placesLoadError => _t('Не удалось загрузить места', 'Joylarni yuklab boʻlmadi');
  String get emptyListTitle => _t('Пока пусто', 'Hozircha boʻsh');
  String get emptyListSubtitle => _t('Здесь пока нет мест', 'Bu yerda hali joylar yoʻq');

  String placesCount(int count) => _uz ? '$count ta joy' : '$count ${_ruPlural(count, 'место', 'места', 'мест')}';
  String reviewsCount(int count) => _uz ? '$count ta sharh' : '$count ${_ruPlural(count, 'отзыв', 'отзыва', 'отзывов')}';
  ...
  String get placeStepTitle => _t('О каком месте отзыв?', 'Qaysi joy haqida sharh?');
  String get placeSearchHint => _t('Название места…', 'Joy nomi…');
  String addPlaceLabel(String name) => _t('Добавить «$name»', '«$name» ni qoʻshish');
  String get placeCategoryLabel => _t('Категория места', 'Joy toifasi');
  String get rateQuestion => _t('Как оцените место?', 'Joyni qanday baholaysiz?');
  String get yourReviewLabel => _t('Ваш отзыв', 'Sizning sharhingiz');
  String get reviewHint => _t('Расскажите, что понравилось или нет…', 'Nima yoqdi yoki yoqmadi — yozing…');
  String get photosOptionalLabel => _t('Фото (по желанию)', 'Fotolar (ixtiyoriy)');
  String get photosComingSoon =>
      _t('Загрузка фото появится в одном из следующих обновлений', 'Foto yuklash keyingi yangilanishlarda qoʻshiladi');
  String get prosQuestion => _t('Что понравилось?', 'Nima yoqdi?');
  String get prosHint => _t('Например: вкусно, быстро, приветливо', 'Masalan: mazali, tez, doʻstona');
  String get consQuestion => _t('Что не понравилось?', 'Nima yoqmadi?');
  String get consHint => _t('Например: долго ждали, шумно', 'Masalan: uzoq kutdik, shovqinli');
  ...
  String get reviewSubmitError =>
      _t('Не удалось отправить отзыв. Проверьте подключение и попробуйте снова', 'Sharhni yuborib boʻlmadi. Ulanishni tekshirib, qayta urinib koʻring');
  String get reviewPublishedTitle => _t('Отзыв опубликован!', 'Sharh eʼlon qilindi!');
  String get reviewPublishedSubtitle => _t('Спасибо! Он уже виден на странице места', 'Rahmat! U joy sahifasida allaqachon koʻrinadi');
  ...
  String get signInPromptSubtitle =>
      _t('Чтобы видеть свой профиль, отзывы и сохранённые места', 'Profilingiz, sharhlar va saqlangan joylarni koʻrish uchun');
  String get signInButton => _t('Войти', 'Kirish');
  String get profileLoadError => _t('Не удалось загрузить профиль', 'Profilni yuklab boʻlmadi');
  ...
  String toGuruLevel(int remaining) =>
      _t('До уровня «Гуру» — ещё $remaining отзывов', '«Guru» darajasigacha yana $remaining ta sharh');
  ...
  String get noReviewsSubtitle =>
      _t('Оставьте первый отзыв о месте, в котором были — это займёт меньше минуты', 'Boʻlgan joyingiz haqida birinchi sharhni qoldiring — bir daqiqadan kam vaqt oladi');
  String get savedSubTabPlaces => _t('Места', 'Joylar');
  String get savedSubTabReviews => _t('Отзывы', 'Sharhlar');
  String get noSavedPlacesTitle => _t('Пока нет сохранённых мест', 'Hozircha saqlangan joylar yoʻq');
  String get noSavedPlacesSubtitle =>
      _t('Нажмите на иконку закладки на карточке места, чтобы сохранить его сюда', 'Bu yerga saqlash uchun joy kartochkasidagi xatcho\'p belgisini bosing');
  String get noSavedReviewsTitle => _t('Пока нет сохранённых отзывов', 'Hozircha saqlangan sharhlar yoʻq');
  String get noSavedReviewsSubtitle => _t('Отмечайте полезные отзывы — они соберутся здесь', 'Foydali sharhlarni belgilang — ular shu yerda toʻplanadi');
  String get noSubscriptionsTitle => _t('Нет подписок', 'Obunalar yoʻq');
  String get noSubscriptionsSubtitle =>
      _t('Подписывайтесь на других пользователей, чтобы видеть их отзывы первыми', 'Boshqa foydalanuvchilarga obuna boʻling — sharhlarini birinchi bo\'lib ko\'ring');
  ...
  String get feedbackButton => _t('Жалобы и предложения', 'Shikoyat va takliflar');
  ...
  String get signUpSubtitle =>
      _t('Регистрация нужна, чтобы оставлять отзывы и сохранять места', 'Sharh qoldirish va joylarni saqlash uchun roʻyxatdan oʻting');
  String get signInSubtitleAuth => _t('Войдите, чтобы оставлять отзывы и сохранять места', 'Sharh qoldirish va joylarni saqlash uchun kiring');
  String get continueWithGoogle => _t('Продолжить с Google', 'Google orqali davom etish');
  String get orDivider => _t('или', 'yoki');
  String get nameHint => _t('Ваше имя', 'Ismingiz');
  String get emailHint => 'Email';
  String get passwordHint => _t('Пароль (минимум 6 символов)', 'Parol (kamida 6 belgi)');
  String get signUpButton => _t('Зарегистрироваться', 'Roʻyxatdan oʻtish');
  String get haveAccountToggle => _t('Уже есть аккаунт? Войти', 'Hisobingiz bormi? Kirish');
  String get noAccountToggle => _t('Нет аккаунта? Зарегистрироваться', 'Hisobingiz yoʻqmi? Roʻyxatdan oʻtish');
  String get checkEmailSnackbar =>
      _t('Проверьте почту, чтобы подтвердить регистрацию, затем войдите', 'Roʻyxatdan oʻtishni tasdiqlash uchun pochtangizni tekshiring, keyin kiring');
  String get googleSignInError => _t('Не удалось войти через Google. Попробуйте ещё раз', 'Google orqali kirib boʻlmadi. Qayta urinib koʻring');
  String get genericError => _t('Что-то пошло не так. Попробуйте ещё раз', 'Nimadir xato ketdi. Qayta urinib koʻring');

  // ---------------------------------------------------------------
  // Жалобы и предложения (feedback_screen.dart)
  // ---------------------------------------------------------------
  String get feedbackIntro =>
      _t('Опишите, что случилось или что хотелось бы улучшить — сообщение придёт прямо разработчикам', 'Nima boʻlganini yoki nimani yaxshilash kerakligini yozing — xabar toʻgʻridan-toʻgʻri dasturchilarga boradi');
  ...
  String get feedbackSendError => _t('Не удалось отправить. Проверьте подключение и попробуйте снова', 'Yuborib boʻlmadi. Ulanishni tekshirib, qayta urinib koʻring');
  String get feedbackSentSnackbar => _t('Спасибо! Сообщение отправлено разработчикам', 'Rahmat! Xabar dasturchilarga yuborildi');
  ...
  String get alreadyHaveAccount => _t('У меня уже есть аккаунт', 'Mening hisobim bor');

  String get onboard1TitlePrefix => _t('Находи лучшие места ', 'Eng yaxshi joylarni ');
  String get onboard1TitleAccent => _t('рядом с тобой', 'yoningizdan toping');
  String get onboard1Subtitle =>
      _t('Рестораны, кафе, парки и торговые центры Ташкента — с честными отзывами настоящих людей', 'Toshkentning restoran, kafe, parklari va savdo markazlari — real odamlarning halol sharhlari bilan');

  String get onboard2TitlePrefix => _t('Выбирай ', 'Tanlang — ');
  String get onboard2TitleAccent => _t('по категориям', 'toifalar boʻyicha');
  String get onboard2Subtitle => _t('Всё, что интересно именно тебе', 'Aynan sizga qiziqarli boʻlgan hamma narsa');

  String get onboard3TitlePrefix => _t('Доверяй ', 'Ishoning — ');
  String get onboard3TitleAccent => _t('реальным отзывам', 'haqiqiy sharhlarga');
  String get onboard3Subtitle => _t('Тысячи оценок от жителей города', 'Shahar aholisidan minglab baholar');
  String get onboardReview1 => _t('Атмосфера просто огонь, обязательно вернёмся', 'Muhiti zoʻr, albatta qaytamiz');
  String get onboardReview2 => _t('Отличное место для семейного отдыха', 'Oilaviy dam olish uchun ajoyib joy');
}
